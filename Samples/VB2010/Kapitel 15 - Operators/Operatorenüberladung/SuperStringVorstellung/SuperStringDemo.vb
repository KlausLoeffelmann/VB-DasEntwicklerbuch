Module Main
    ...
    Sub Main()
        ...
        locNormaloString = locNormaloString + "Wand schlägt, verbraucht man 150 Kalorien."
    ...
    Sub ExperimenteFürBoolscheAusdrücke()
        ...
        Dim locSupStr As SuperString = New SuperString(Console.ReadLine)
        If locSupStr Then
...
Public Structure SuperString
    ...
    Public Shared Operator +(ByVal sstring1 As SuperString, ByVal sstring2 As String) As SuperString
        Return sstring1.Addieren(New SuperString(sstring2))
    End Operator
    ...
    Public Shared Operator IsTrue(ByVal sString As SuperString) As Boolean
        Dim locString As String = sString.ToString
