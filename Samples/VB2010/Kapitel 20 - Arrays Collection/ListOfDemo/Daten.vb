...
Public Class Adresse
    ...
    Sub New(ByVal Matchcode As String, ByVal Name As String, _
            ByVal Vorname As String, ByVal Plz As String, ByVal Ort As String)
...
#End Region
    ...
    Shared Sub AdressenAusgeben(ByVal Adressen As List(Of Adresse))
