Module HashtableDemo
    ...
    Sub Main()
        ...
        Console.Write("Erzeugen von {0} zufäligen Adresseneinträgen...", locAnzahlAdressen)
        locZeitmesser.Start()
        ...
        Console.Write("Aufbauen der Hashtable mit zufäligen Adresseneinträgen...", locAnzahlAdressen)
        locZeitmesser.Start()
        ...
        For z As Integer = 1 To locMessungen
            ...
            For i As Integer = 0 To locZugriffsElemente
                ...
                locZeitmesser.Start()
                For j As Integer = 1 To locZugriffe
                    locTemp3 = locVorlageAdressen(0)
                Next j
                locZeitmesser.Stop()
                locTemp3 = locTemp3.GetType
                Console.WriteLine("{0} ms", locZeitmesser.DurationInMilliSeconds)
            Next
