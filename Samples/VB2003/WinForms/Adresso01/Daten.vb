Public Class Adresse
    ...
    Sub New(ByVal Name As String, ByVal Vorname As String, ByVal Straﬂe As String, _
    ...
    Sub New(ByVal Matchcode As String, ByVal Name As String, ByVal Vorname As String, _
            ByVal Straﬂe As String, ByVal Plz As String, ByVal Ort As String)
...
Public Class Adressen
    ...
    Public Sub FillListView(ByVal listview As ListView)
        listview.Items.Clear()
        For Each locAdresse As Adresse In AdrMain.Adressen
            Dim locStrings(5) As String
            Dim locListViewItem As ListViewItem
            locStrings(0) = locAdresse.Matchcode
            locStrings(1) = locAdresse.Name
            locStrings(2) = locAdresse.Vorname
            locStrings(3) = locAdresse.Straﬂe
            locStrings(4) = locAdresse.PLZ
            locStrings(5) = locAdresse.Ort
            locListViewItem = New ListViewItem(locStrings)
            locListViewItem.Tag = locAdresse.Matchcode
            listview.Items.Add(locListViewItem)
        Next
    End Sub
