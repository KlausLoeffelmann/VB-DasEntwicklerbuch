...
Module mdlMain
    ...
    Sub Main()
        ...
        Console.WriteLine("Klasse1 ergibt durch InString: " & klasse1.InString())

        Dim klasse2 As New ZweiteKlasse(5)
        Console.WriteLine("Klasse2 ergibt durch InString: " & klasse2.InString())
...
Class ErsteKlasse
    ...
    Public Overridable Function InString() As String
...
Class ZweiteKlasse
    ...
    Public Overrides Function InString() As String
        Return "der Wert lautet: " & MyBase.InString()
    End Function
