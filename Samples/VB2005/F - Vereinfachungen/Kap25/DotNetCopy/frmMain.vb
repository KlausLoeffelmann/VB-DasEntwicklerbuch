...
Public Class frmMain
    ...
    Private Sub frmMain_Load(ByVal sender As Object, ByVal e As System.EventArgs) _
        ...
        'Fenstergröße und -position widerherstellen, wenn
    ...
    Private Sub tsmFileSaveCopyList_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmFileSaveCopyList.Click, tsbSaveCopyList.Click
        ...
        Dim locOsd As New SaveFileDialog
        With locOsd
            .DefaultExt = "*.ols"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub tsmEditCopyListEntryDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsmEditCopyListEntryDelete.Click, tsbDeleteCopyListEntry.Click
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub lvwCopyEntries_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lvwCopyEntries.SelectedIndexChanged
    ...
    Private Sub SaveCopyEntryList(ByVal copyEntryListPath As String)
        ...
        For Each locItem As ListViewItem In lvwCopyEntries.Items
            ...
            locCopyListEntry = CType(locItem.Tag, CopyListEntry)
