...
Public Class LaengenFormatInfo
    ...
    Public Function Format(ByVal formatChars As String, _
        ...
        With locLaengenFormatInfo
            ...
            End If
        End With
        'Der Compiler bringt an dieser Stelle eine Warnung,
        'versteht allerdings nicht, dass der von ihm vermutete
        'Fall nicht eintreffen kann.
    End Function
