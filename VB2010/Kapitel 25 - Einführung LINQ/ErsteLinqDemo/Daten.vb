...
Public Class Artikel
    Private myIDGekauftVon As Integer
    Private myArtikelName As String
    Private myArtikelNummer As String
    Private myKategorie As String
    Private myAnzahl As Integer
    Private myEinzelpreis As Decimal
