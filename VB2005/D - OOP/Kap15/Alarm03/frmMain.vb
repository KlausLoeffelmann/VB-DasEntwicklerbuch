Public Class frmMain
    ...
    'Müssen wir in dieser Version selbst ermitteln,
    'um den nächsten Termin darzustellen.
    ...
    'Rückrufroutine des Alarmgeber-Delegaten, die aufgerufen wird,
    'wenn der Alarmgeber Alarm signalisiert, weil eine
    'bestimmte Uhrzeit erreicht wurde.
    Private Sub myAlarmgeber_Alarm(ByVal Sender As Object, ByVal e As AlarmEventArgs)
        'Wecker schellt!
        myAlarmStatus = True
        'Und zwar so lange.
    ...
    Private Sub picWecker_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) _
        ...
        If lstTermine.Items.Count > -1 Then
            'Wenn es Termine gibt, dann die Markierung des nächsten einzeichnen
            DrawClock(e.Graphics, Date.Now, myNächsterTermin, _
    ...
    Private Sub FindeNächstenTermin()
        ...
        Else
            ...
            'als alle anderen ist. Da wir auf eine Objektliste zugreifen,
            'müssen wir von Object in Alarmgeber casten - können dann aber
            'wie hier im Beispiel direkt auf die Eigenschaft zugreifen.
            myNächsterTermin = DirectCast(lstTermine.Items(0), Alarmgeber).Alarmzeit

            'For Each übernimmt für jedes Element ein explizites Casting
            '(wir iterieren zwar durch eine Object-Auflistung, geben aber den Typ explizit an).
            For Each locItem As Alarmgeber In lstTermine.Items
