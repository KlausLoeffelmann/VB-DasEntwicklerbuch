...
Public Class frmMain
    ...
    Private myGridLineWidth As Single
    ...
    'Definiert das Seitenverhältnis
    Private myXYRatio As Single

    'Flag, das festhält, ob das Formular gerade bewegt wurde
    Private myJustMoved As Boolean
    ...
    'Wird aufgerufen, wenn der Hintergrund aus irgendeinem Grund neugezeichnet werden muss
    Protected Overrides Sub OnPaintBackground(ByVal pevent As System.Windows.Forms.PaintEventArgs)
        paintBackground(pevent.Graphics)
    End Sub

    'Kann in dieser Version ausgelassen werden, durch das Setzen des entsprechenden
    'Flags im Konstruktor dieser Klasse (ControlStyles.ResizeRedraw)
    ...
    Private Sub paintContent(ByVal g As Graphics)
        ...
        'Linienstärke bei der Umfangberechnung des Kreises mit einbeziehen
        locRectF = New RectangleF((ClientSize.Width / 2.0! - ClientSize.Height / 2.0!) + GridLineWidth / 2, _
                                GridLineWidth / 2.0!, _
                                ClientSize.Height - GridLineWidth / 2, _
                                ClientSize.Height - (GridLineWidth))
        g.DrawEllipse(locPen, locRectF)

        locPen.Width = GridLineWidth
        ...
        drawStringInFrame(g, New SolidBrush(Color.White), "VB 2005", "Arial", _
    ...
    Private Sub paintGrid(ByVal g As Graphics)
        ...
        Else
            ...
            '    Else
            '        g.DrawLine(locPen, x - GridLineWidth / 2, GridLineWidth / 2, x - GridLineWidth / 2, ClientSize.Height)
            '    End If
            'Next
            ...
            '    Else
            '        g.DrawLine(locPen, GridLineWidth / 2, y - GridLineWidth / 2, ClientSize.Width, y - GridLineWidth / 2)
            '    End If
            'Next
    ...
    Public ReadOnly Property GridSize() As SizeF
        Get
            ...
            'Return New SizeF(CSng(ClientSize.Width / GridCols), _
            ...
            Return New SizeF(CSng((ClientSize.Width - GridLineWidth) / GridCols), _
    ...
    Public Property GridLineWidth() As Single
        Get
