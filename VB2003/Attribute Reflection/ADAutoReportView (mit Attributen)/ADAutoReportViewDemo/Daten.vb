...
#Region "Eigenschaften"
    <ADAutoReportColumn("Kennung", -2, 0)> _
    ...
    <ADAutoReportColumn("Nachname", -2, 2)> _
    ...
    <ADAutoReportColumn("Vorname", -2, 1)> _
    ...
    <ADAutoReportColumn("Postleitzahl", -2, 3)> _
