...
#End Region
    ...
    '"Zeiger" auf den Hauptthread, der vom Ereignis-Handler
    'von SortCompletion wieder zum Leben erweckt werden soll
    Private myThreadToRewake As Thread
    ...
    Private Sub StartMainThread()
        ...
        If Not myUseTwoThread Then
            ...
            myThreadToRewake = Thread.CurrentThread
