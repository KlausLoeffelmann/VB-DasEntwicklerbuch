Module Arrays
    ...
    Sub Main()
        ...
        ' Dieses Projekt fasst mehrere Beispiele zusammen.
    ...
    Sub Beispiel5()
        ...
        Dim locCharArray As Char() = {"V"c, "B"c, "."c, "N"c, "E"c, "T"c, " "c,
        ...
        'Neu seit Visual Basic 2010
        'Typrückschluss für Arrays:
        Dim locWasWirdEsWohl = {2, 4, 8, 16, 32, 64, 128}

        'Ein Typ dominiert.
        Dim locUndDasHier = {2, 4, 5.6F, 10.266212122326667R}

        'Das geht nicht - Object-Arrays gibt nur bei Option Strict Off!
        'Dim nocheineVersion = {10, "c"c, "Ein Text", #7/24/1969#}
    ...
    Sub Beispiel6()
        ...
        'Verschachtelt anstelle von Redim:
        Dim AuchEinfachVerschachtelt As Integer()()
        AuchEinfachVerschachtelt = New Integer(10)() {}
