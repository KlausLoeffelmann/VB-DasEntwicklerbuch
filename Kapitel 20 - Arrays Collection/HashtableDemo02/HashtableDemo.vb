    ...
    Sub Main()
        ...
        For z As Integer = 1 To locMessungen
            ...
            For i As Integer = 0 To locZugriffsElemente
                ...
                Next j
                locZeitmesser.Stop()
                'Besser ist besser: Nicht das der Compiler merkt,
                'dass locTemp2 gar nicht benötigt wird, und es wegoptrimiert!
        ...
        For Each locDE As DictionaryEntry In locAdressen
            ...
            Dim locAdressenKey = DirectCast(locDE.Key, AdressenKey)
            'in unserem Beispiel für das Objekte
            Dim locAdresse = DirectCast(locDE.Value, Adresse)
        Next
    End Sub
