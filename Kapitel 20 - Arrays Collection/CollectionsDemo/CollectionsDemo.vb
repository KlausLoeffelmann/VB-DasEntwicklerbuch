...
Module CollectionsDemo
    ...
    Sub ArrayListDemo()
        ...
        Dim locHundeNamenList As New ArrayList From {"Waldi", "Basko", "Hasso",
                                                     "Wauzi", "Bello", "Minka"}
    ...
    Sub QueueDemo()
        ...
        'Die typsichere Version mit Generics würde lauten:
        Dim typsafeQueue As New Queue(Of String)
    ...
    Sub StackDemo()
        ...
        'Die typsichere Version mit Generics würde lauten:
        Dim typeSafeStack As New Stack(Of String)
